...
define i1 @Tree.Compare(i8* %this, i32 %.num1, i32 %.num2) {
	...
	br i1 %_4, label %if_then0, label %if_else0
		if_then0:
		store i1 0, i1* %ntb
		br label %if_end0
		if_else0:
		...
		%_5 = xor i1 1, %_8
		br i1 %_5, label %if_then1, label %if_else1
			if_then1:
			store i1 0, i1* %ntb
			br label %if_end1
			if_else1:
...
define i1 @Tree.Insert(i8* %this, i32 %.v_key) {
	...
	store i1 1, i1* %cont
		...
		br i1 %_21, label %if_then2, label %if_else2
			if_then2:
			...
			br i1 %_28, label %if_then3, label %if_else3
				if_then3:
			...
			br i1 %_57, label %if_then4, label %if_else4
				if_then4:
...
define i1 @Tree.Delete(i8* %this, i32 %.v_key) {
	...
	store i1 1, i1* %is_root
		...
		br i1 %_10, label %if_then5, label %if_else5
			if_then5:
			...
			br i1 %_17, label %if_then6, label %if_else6
				if_then6:
			...
			br i1 %_28, label %if_then7, label %if_else7
				if_then7:
				%_29 = load i8*, i8** %current_node
				...
				br i1 %_35, label %if_then8, label %if_else8
					if_then8:
					%_36 = load i8*, i8** %current_node
				...
				br i1 %_44, label %if_then9, label %if_else9
					if_then9:
					...
					%_53 = xor i1 1, %_60
					%_61 = and i1 %_45, %_53
					br i1 %_61, label %if_then10, label %if_else10
						if_then10:
						store i1 1, i1* %ntb
						br label %if_end10
						if_else10:
...
define i1 @Tree.Remove(i8* %this, i8* %.p_node, i8* %.c_node) {
	...
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if_then11, label %if_else11
		if_then11:
		...
		br i1 %_21, label %if_then12, label %if_else12
			if_then12:
			...
			br i1 %_57, label %if_then13, label %if_else13
				if_then13:
...
define i32 @Tree.Search(i8* %this, i32 %.v_key) {
	...
	store i32 0, i32* %ifound
		...
		%_10 = icmp slt i32 %_8, %_9
		br i1 %_10, label %if_then14, label %if_else14
			if_then14:
			%_11 = load i8*, i8** %current_node
			...
			%_16 = bitcast i8* %_15 to i1(i8*)*
			%_17 = call i1 %_16(i8* %_11)
			br i1 %_17, label %if_then15, label %if_else15
				if_then15:
				%_18 = load i8*, i8** %current_node
			...
			br i1 %_27, label %if_then16, label %if_else16
				if_then16:
				...
				br i1 %_34, label %if_then17, label %if_else17
					if_then17:
...
define i1 @Tree.RecPrint(i8* %this, i8* %.node) {
	...
	%_5 = bitcast i8* %_4 to i1(i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if_then18, label %if_else18
		if_then18:
		%_7 = bitcast i8* %this to i8***
		%_8 = load i8**, i8*** %_7
	...
	br i1 %_33, label %if_then19, label %if_else19
		if_then19:
...
define i32 @Visitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1(i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if_then20, label %if_else20
		if_then20:
	...
	br i1 %_31, label %if_then21, label %if_else21
		if_then21:
...
define i32 @MyVisitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1(i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %if_then22, label %if_else22
		if_then22:
		%_7 = getelementptr i8, i8* %this, i32 16
		%_8 = bitcast i8* %_7 to i8**
	...
	br i1 %_38, label %if_then23, label %if_else23
		if_then23:
