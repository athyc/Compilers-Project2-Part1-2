...
define i1 @Element.Equal(i8* %this, i8* %.other) {
	...
	%_11 = load i8*, i8** %_10
	%_12 = bitcast i8* %_11 to i1(i8*, i32, i32)*
	...
	%_17 = call i1 %_12(i8* %this, i32 %_13, i32 %_16)
	%_7 = xor i1 1, %_17
	br i1 %_7, label %if_then0, label %if_else0
		if_then0:
		...
		%_35 = call i1 %_30(i8* %this, i32 %_31, i32 %_34)
		%_25 = xor i1 1, %_35
		br i1 %_25, label %if_then1, label %if_else1
			if_then1:
			store i1 0, i1* %ret_val
			br label %if_end1
			if_else1:
			...
			br i1 %_38, label %if_then2, label %if_else2
				if_then2:
				%_40 = load i8*, i8** %other
				...
				%_39 = xor i1 1, %_46
				br i1 %_39, label %if_then3, label %if_else3
					if_then3:
					store i1 0, i1* %ret_val
					br label %if_end3
					if_else3:
				...
				br i1 %_53, label %if_then4, label %if_else4
					if_then4:
					store i1 0, i1* %ret_val
					br label %if_end4
					if_else4:
...
define i1 @Element.Compare(i8* %this, i32 %.num1, i32 %.num2) {
	...
	br i1 %_4, label %if_then5, label %if_else5
		if_then5:
		store i1 0, i1* %retval
		br label %if_end5
		if_else5:
		...
		%_5 = xor i1 1, %_8
		br i1 %_5, label %if_then6, label %if_else6
			if_then6:
			store i1 0, i1* %retval
			br label %if_end6
			if_else6:
...
define i8* @List.Delete(i8* %this, i8* %.e) {
	...
	store i8* %_6, i8** %var_elem
		...
		br i1 %_19, label %if_then7, label %if_else7
			if_then7:
			store i1 1, i1* %ret_val
			%_20 = load i32, i32* %aux04
			
			%_21 = icmp slt i32 %_20, 0
			br i1 %_21, label %if_then8, label %if_else8
				if_then8:
		...
		%_45 = xor i1 1, %_46
		br i1 %_45, label %if_then9, label %if_else9
			if_then9:
...
define i32 @List.Search(i8* %this, i8* %.e) {
	...
	store i8* %_5, i8** %var_elem
		...
		%_6 = xor i1 1, %_7
		br i1 %_6, label %loop4, label %loop5
		loop4:
		%_8 = load i8*, i8** %e
		...
		br i1 %_15, label %if_then10, label %if_else10
			if_then10:
